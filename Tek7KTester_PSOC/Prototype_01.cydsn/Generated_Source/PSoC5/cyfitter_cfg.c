...
#define BS_UDB_1_2_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800056Cu)

/* UDB_1_1_0_CONFIG Address: CYDEV_UCFG_B1_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480005ECu)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800066Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000674u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP3_SW0, 0x08u);
...
uint8 CYXDATA * const CYCODE VSense_ADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE VSense_ADC_AMux__maskTable[2] = {
	0x40u, 
	0x20u, 
};

/*******************************************************************************
* Function Name: VSense_ADC_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void VSense_ADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*VSense_ADC_AMux__addrTable[channel] |= VSense_ADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: VSense_ADC_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void VSense_ADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*VSense_ADC_AMux__addrTable[channel] &= (uint8)~VSense_ADC_AMux__maskTable[channel];
	}
}
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P3_U0_CFG24), 0x0429C0C8u);
