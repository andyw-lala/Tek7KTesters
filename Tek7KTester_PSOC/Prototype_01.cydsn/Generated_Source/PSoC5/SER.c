...
*
* \funcusage
*  \snippet SER_SUT.c usage_SER_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet SER_SUT.c usage_SER_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet SER_SUT.c usage_SER_Read  
*******************************************************************************/
uint8 SER_Read(void)
{
...
* preferred SER_Read() API because the 
* SER_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet SER_SUT.c usage_SER_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: SER_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use SER_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - SER_0_INTR       (First pin in the list)
    *  - SER_1_INTR       (Second pin in the list)
    *  - ...
    *  - SER_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet SER_SUT.c usage_SER_SetInterruptMode
    *******************************************************************************/
    void SER_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & SER_0_INTR) != 0u) 
		{ 
			 SER_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet SER_SUT.c usage_SER_ClearInterrupt
    *******************************************************************************/
