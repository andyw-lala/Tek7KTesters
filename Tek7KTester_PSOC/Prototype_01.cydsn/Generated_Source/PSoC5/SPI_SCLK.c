...
{
    uint8 staticBits = (SPI_SCLK_DR & (uint8)(~SPI_SCLK_MASK));
    SPI_SCLK_DR = staticBits | ((uint8)(value << SPI_SCLK_SHIFT) & SPI_SCLK_MASK);
}
...
{
	CyPins_SetPinDriveMode(SPI_SCLK_0, mode);
}
...
{
    return (SPI_SCLK_PS & SPI_SCLK_MASK) >> SPI_SCLK_SHIFT;
}
...
{
    return (SPI_SCLK_DR & SPI_SCLK_MASK) >> SPI_SCLK_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(SPI_SCLK_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & SPI_SCLK_0_INTR) != 0u) 
		{ 
			 SPI_SCLK_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (SPI_SCLK_INTSTAT & SPI_SCLK_MASK) >> SPI_SCLK_SHIFT;
    }
