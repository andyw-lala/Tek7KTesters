...
CY_ISR(Display_SPI_TX_ISR)
{
    ...
    #ifdef Display_SPI_TX_ISR_ENTRY_CALLBACK
        Display_SPI_TX_ISR_EntryCallback();
    #endif /* Display_SPI_TX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef Display_SPI_TX_ISR_EXIT_CALLBACK
        Display_SPI_TX_ISR_ExitCallback();
    #endif /* Display_SPI_TX_ISR_EXIT_CALLBACK */
}
...
CY_ISR(Display_SPI_RX_ISR)
{
    ...
    #ifdef Display_SPI_RX_ISR_ENTRY_CALLBACK
        Display_SPI_RX_ISR_EntryCallback();
    #endif /* Display_SPI_RX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef Display_SPI_RX_ISR_EXIT_CALLBACK
        Display_SPI_RX_ISR_ExitCallback();
    #endif /* Display_SPI_RX_ISR_EXIT_CALLBACK */
}
