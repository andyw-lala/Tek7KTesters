...
#define Display_SPI_INTERNAL_CLOCK             (1u)
...
#define Display_SPI_TX_BUFFER_SIZE             (16u)
#define Display_SPI_RX_BUFFER_SIZE             (4u)
#define Display_SPI_INTERNAL_TX_INT_ENABLED    (1u)
...
#define Display_SPI_INT_ON_TX_NOT_FULL ((uint8) (1u << \
...
#define Display_SPI_CONTROL_REG            (* (reg8 *) \
                                      Display_SPI_BSPIM_BidirMode_CtrlReg__CONTROL_REG)
